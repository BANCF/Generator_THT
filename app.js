...
const AI_TOPICS_DATA = {
  cap1: [
    { value: "scratch_draw_basic", text: "Vẽ hình: Cơ bản (Tròn, vuông, đa giác...)" },
    { value: "scratch_draw_art", text: "Vẽ hình: Nghệ thuật hoa văn xoay" },
    { value: "scratch_math", text: "Số học: Dãy số cách đều & Quy luật" },
    { value: "scratch_counting", text: "Số học: Đếm số chia hết & Ước chung" },
    { value: "scratch_word", text: "Xâu ký tự: Xử lý chuỗi Scratch" },
    { value: "scratch_grid", text: "Vẽ hình: Vẽ lưới tọa độ nhân vật" },
    { value: "scratch_logic", text: "Toán cổ & Logic (Gà chó, trâu cỏ...)" },
    { value: "scratch_list", text: "Danh sách (List): Tìm Max, Min, TBC..." },
    { value: "other", text: "Chủ đề khác..." }
  ],
  cap2: [
    { value: "c2_math_prime", text: "Số học: Số nguyên tố & Sàng nguyên tố" },
    { value: "c2_math_divisors", text: "Số học: Ước số, Bội số, Euclid" },
    { value: "c2_math_base", text: "Số học: Hệ cơ số & Lũy thừa" },
    { value: "c2_string_basic", text: "Xâu ký tự: Chuẩn hóa, Đảo ngược, Tần suất" },
    { value: "c2_string_rle", text: "Xâu ký tự: Mã hóa nén chuỗi (RLE, Caesar)" },
    { value: "c2_string_palin", text: "Xâu ký tự: Đối xứng (Palindrome)" },
    { value: "c2_array_sort", text: "Mảng: Sắp xếp, Tìm kiếm nhị phân" },
    { value: "c2_array_pointers", text: "Mảng: Hai con trỏ & Cửa sổ trượt" },
    { value: "c2_dp_basic", text: "Quy hoạch động: Balo (Knapsack), Đổi tiền" },
    { value: "c2_dp_lcs_lis", text: "Quy hoạch động: Xâu con chung (LCS), Dãy tăng (LIS)" },
    { value: "c2_dp_grid", text: "Quy hoạch động: Đường đi trên lưới" },
    { value: "c2_greedy", text: "Thuật toán tham lam (Greedy)" },
    { value: "c2_graph", text: "Đồ thị: Tìm kiếm BFS/DFS cơ bản" },
    { value: "other", text: "Chủ đề khác..." }
  ]
};
